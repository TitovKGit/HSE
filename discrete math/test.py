...
def test_sat5():
    ...
    result = boolean.is_satisfiable(cnf);
    assert(not result), "Wrong answer";
...
def test_assign3():
    ...
    q = a['q'];
    r = a['r'];
    assert (((not p) or q) and ((not p) or r) and ((not q) or r) and (p or (not q)) and ((not p) or (not q)) and ((not p) or (not r))), "Wrong answer";
...
def test_assign4():
    ...
    q = a['q'];
    r = a['r'];
    assert (((not p) or q) and ((not q) or (not r)) and ((not r) or p)), "Wrong answer";
